...
With embedded urls: ( download the hardcoded list of files in the 'files =' block below)
    ...
    python ./download_two_path_150.py

Download all files in a Metalink/CSV: (downloaded from ASF Vertex)

    python ./download-all-2025-06-23_10-48-20.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
...
class bulk_downloader:
    def __init__(self, dest_dir: Path = DOWNLOAD_DIR):
        ...
        self.files = [ "https://datapool.asf.alaska.edu/L1.0/A3/ALPSRP107520510-L1.0.zip",
